...
import { Star, Shield, Clock, Info, CheckCircle2 } from 'lucide-react';
    ...
    <div className="pt-24 pb-20 bg-slate-50 min-h-screen">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex items-center space-x-2 text-sm text-gray-500 mb-8">
          ...
          <span>/</span>
          <Link href={`/${city}`} className="hover:text-purple-600">{cityName}</Link>
          <span>/</span>
                 ...
                 >
                   <div className="flex flex-col md:flex-row gap-8">
                      ...
                      <div className="md:w-48 shrink-0 flex flex-col justify-between">
                         <div className="aspect-square bg-gray-100 rounded-2xl flex items-center justify-center text-4xl mb-4">
                            {pkg.image}
                         </div>
                         <button className="w-full py-3 bg-purple-600 text-white font-bold rounded-xl hover:bg-purple-700 transition-all active:scale-95">
                            Add to Cart
                         </button>
                      </div>
                   </div>
             ...
             <div className="sticky top-24 space-y-6">
                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                   ...
                   <ul className="space-y-6">
                      {[
                        { icon: <Shield size={20} className="text-purple-600" />, title: 'UC Safe Guard', desc: 'Insurance up to ₹10,000' },
                        { icon: <Clock size={20} className="text-purple-600" />, title: 'Fixed Pricing', desc: 'No hidden charges' },
                        { icon: <CheckCircle2 size={20} className="text-purple-600" />, title: 'Quality Assured', desc: 'Service warranty included' },
                      ].map((item, i) => (
                ...
                <div className="bg-purple-600 rounded-3xl p-8 text-white relative overflow-hidden">
                   <div className="relative z-10">
                      ...
                      <p className="text-purple-100 text-sm mb-6">Get ₹100 off on your next booking by inviting your friends.</p>
                      <button className="w-full py-3 bg-white text-purple-600 font-bold rounded-xl text-sm">Refer Now</button>
                   </div>
